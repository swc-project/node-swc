...
const PARSERS = [
  ['swc (es3)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      target: 'es3',
      parser: {
        syntax: "typescript",
  ...
  ['swc (es5)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      target: 'es5',
      parser: {
        syntax: "typescript",
  ...
  ['swc (es2015)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      target: 'es2015',
      parser: {
        syntax: "typescript",
  ...
  ['swc (es2016)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      target: 'es2016',
      parser: {
        syntax: "typescript",
  ...
  ['swc (es2017)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      target: 'es2017',
      parser: {
        syntax: "typescript",
  ...
  ['swc (es2018)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      target: 'es2018',
      parser: {
        syntax: "typescript",
  ...
  ['swc-optimize (es3)', "../swc/", (module) => module.transformSync(SOURCE, {
    jsc: {
      parser: {
        syntax: "typescript",
      },
